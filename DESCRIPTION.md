...
The three-minute wow moment is Claim to Commit auditing its own Build Week repository. A real headline feature expands into six verified artifacts. Then Audit Mode exposes an impressive claim—“perfectly infers evidence relationships”—as unsupported because it has no attributable implementation or passing test. Confident prose becomes visibly red, with exact remediation guidance.
